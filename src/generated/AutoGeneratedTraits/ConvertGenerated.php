...
/**
 * Auto generated from 'convert -h' help
 */
trait ConvertGenerated
{
	...
	{
		return $this->addOpt('-blueShift', $factor );
	}
	...
	{
		return $this->addOpt('-interpolativeResize', $geometry );
	}
	...
	/**
	 * Radial blur the image (deprecated use -rotational-blur.
	 * @param $angle string Angle
	 */
	...
	{
		return $this->addOpt('-rotationalBlur', $angle );
	}
	 ...
	 * @param $geometry string Geometry
	 */
	public function statistic($type, $geometry)
	{
		return $this->addOpt('-statistic', $type." ".$geometry );
	}
